...
public class RechFragTeacher extends Fragment {
    ...
    RecyclerView rv;
    private ArrayList<TeacherModel> list_rech;

    public RechFragTeacher(){

    }
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState){
        View v = inflater.inflate(R.layout.frag_rech_teacher,container,false);
        rv= v.findViewById(R.id.rvrech);
    ...
    private void getExpTeacher() {
        list_rech=new ArrayList<>();
        String url="http://eniso.info/ws/core/wscript?s=Return(bean(%27academicProfile%27).findTeacherCvItemsBySection("+ActivityTeacher.idteacher+",4))";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i=0;i<all.length();i++){
                                ...
                                list_rech.add(new TeacherModel("Titre",title,"Etablissement",etab,"Détails",details,"Mots_Clés",key));
                            }




                            Adapt=new AdapterTeacher(contex,list_rech);
                            rv.setAdapter(Adapt);
