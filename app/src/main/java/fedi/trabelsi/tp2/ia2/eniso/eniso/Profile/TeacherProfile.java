...
public class TeacherProfile extends AppCompatActivity {
    ...
    public void getid(){
        ...
        String url="http://eniso.info/ws/core/wscript?s=Return(bean(%22academic%22).findTeacherByUser("+ Login.id+"))";
                ...
                (Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            String teacherid= alldonné.getString("id");
                            ActivityTeacher.idteacher=teacherid;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_teacher_profile2, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                ...
                case 0: return new CordonFragTeacher();
                case 1: return new FormaFragTeacher();
                case 2 :return new CoursFragTeacher();
                case 3: return new ProjFragTeacher();
                case 4: return new ExpFragTeacher();
                case 5 : return new RechFragTeacher();
