...
public class TeacherTimeTable extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_teacher_time_table, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_teacher_time_table, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0 : return new En_Lundi();
                case 1 : return new En_Mardi();
                case 2 : return new En_Mercredi();
                case 3 : return new En_Jeudi();
                case 4 : return new En_Vendredi();
                case 5 : return new En_Samedi();
                default: return null;
            }
        }
