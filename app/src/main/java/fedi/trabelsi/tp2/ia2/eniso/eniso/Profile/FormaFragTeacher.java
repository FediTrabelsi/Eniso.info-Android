...
public class FormaFragTeacher extends Fragment {
    Button mise;
    RequestQueue mQueue;
    Context contex;
    AdapterTeacher Adapt;
    RecyclerView rv;
    private ArrayList<TeacherModel> list_forma;

    public FormaFragTeacher(){

    }
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState){
        View v = inflater.inflate(R.layout.frag_form_teacher,container,false);
        rv= v.findViewById(R.id.rvforma);
    ...
    private void getFormaTeacher() {
        list_forma=new ArrayList<>();
        String url="http://eniso.info/ws/core/wscript?s=Return(bean(%27academicProfile%27).findTeacherCvItemsBySection("+ActivityTeacher.idteacher+",5))";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i=0;i<all.length();i++){
                                ...
                                list_forma.add(new TeacherModel("Titre",title,"Etablissement",etab
                                ,"Détails",details,"Mots_Clés",key));
                           ...
                           Adapt=new AdapterTeacher(contex,list_forma);
                            rv.setAdapter(Adapt);
